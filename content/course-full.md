...
- 6. Cuidados del bebé
  ...
  - Higiene, cólicos y masaje infantil (higiene-recien-nacido)
  - Pañales, cacas y cuidado del culete (panales-cacas-culete)

## Contenido

# 1. Prepararse antes del parto

<!-- lesson-id: final-embarazo -->
# Final del embarazo

Este módulo sirve para ordenar lo que ocurre en las últimas semanas y preparar el contexto antes del parto.

## Apuntes a completar

- Cambios físicos normales del tercer trimestre.
- Contracciones de Braxton Hicks y pródromos.
- Descanso, movimiento, alimentación e hidratación.
- Preparación emocional y dudas frecuentes.
- Papel de la pareja o acompañante.
...
El objetivo no es controlar todo, sino reconocer lo esperable, saber cuándo consultar y llegar con recursos prácticos.

<!-- lesson-id: senales-parto -->
# Señales de parto y señales de alarma

Esta lección separa señales habituales de inicio de parto de situaciones en las que conviene consultar de forma urgente.

## Señales compatibles con inicio de parto

- Contracciones rítmicas que aumentan en intensidad y frecuencia.
- Pérdida del tapón mucoso.
- Rotura de bolsa.
- Cambios digestivos, presión pélvica o necesidad de recogimiento.

## ⏱️ Cuándo ir al hospital ✨✨✨
...
- El día del parto se entra por urgencias
...
- Alivio del dolor.
- Tacto vaginal e intervenciones.
- Piel con piel.
- Inicio de lactancia.
...
- Enema previo:
  - ❌ No
- Desea ingerir líquidos de forma moderada
- Desea elegir postura durante el proceso
- Desea escuchar música y usar objetos personales durante la dilatación

### 💉 Tratamiento y manejo del dolor ✨✨✨

- Epidural:
  - ✔️ Sí
  - Preferiblemente cuando el personal considere que es el momento más conveniente

- Otras técnicas de alivio del dolor:
  - Óxido nitroso
  - Pelotas de pilates
  - Movimiento
...
- Preferencia:
  - Usar métodos alternativos mientras sea posible antes de epidural
...
- Donación de sangre de cordón:
  - ❌ No
- No donar ni conservar

- En caso de cesárea:
  - Piel con piel:
    - Preferiblemente la madre si es posible
    - Si no, puede hacerlo el acompañante

### 🍼 Lactancia ✨✨✨

- Desea dar el pecho
- Desea información sobre grupos de apoyo a la lactancia
- No desea fórmula inicialmente

### 🧠 Filosofía general ✨✨✨

- El documento puede modificarse durante el proceso
- Prioridad:
  - Seguridad de madre y bebé
- Importancia de:
  - Movilidad
  - Acompañamiento
  - Analgesia epidural si se necesita
  - Técnicas alternativas de alivio del dolor
  - Piel con piel
...
- Neceser y elementos de higiene.
...
- Paños de algodón
- Gasas
- Ropa para salir del hospital (puesta)
- Gorrito
- Gel y crema (Weleda)
...
<!-- lesson-id: fases-parto -->
# Fases del parto

Una visión ordenada de las fases ayuda a entender qué puede pasar y qué recursos usar en cada momento.

## Fase latente

Contracciones irregulares o progresivas. Suele ser buen momento para descansar, hidratarse, moverse suave y observar.

## Dilatación activa

Las contracciones son más intensas y regulares. Pueden ayudar respiración, movimiento, agua, masaje, cambios de postura y acompañamiento.

## Expulsivo

Etapa de nacimiento del bebé. Conviene trabajar pujos, posturas, comunicación con el equipo y protección del periné.
...
El dolor de parto cambia según la fase, la posición del bebé, el cansancio, el entorno y los recursos disponibles.

## Recursos no farmacológicos

- Respiración consciente.
- Movimiento libre.
- Pelota, balanceo y posturas verticales.
- Calor local o ducha si está disponible.
- Masaje, presión sacra y contacto.
- Voz, música y ambiente tranquilo.
...
<!-- lesson-id: primeras-horas -->
# Piel con piel y primeras revisiones

Las primeras horas combinan recuperación, observación clínica, vínculo e inicio de la alimentación.

## Contenidos

- Piel con piel.
- Pinzamiento del cordón si procede.
- Primer agarre.
- Valoración inicial del bebé.
- Recuperación materna inmediata.
- Qué puede ocurrir en sala de partos o habitación.

## Nota

Completar con protocolos reales del centro de referencia para evitar prometer prácticas que dependan del hospital.
...
- Sangrado.
- Entuertos.
- Puntos, cesárea o suelo pélvico.
- Cansancio, sueño y alimentación.
- Revisiones.
...
- Intentar levantarse y andar cuanto antes si el equipo médico lo permite
- El movimiento progresivo suele ayudar a la recuperación
- Las primeras veces es recomendable no ir sola al baño
- Pedir ayuda si hay mareo, debilidad o inseguridad
- Nota:
...
<!-- lesson-id: lactancia -->
# Inicio de lactancia y alimentación
...
- Útil para aliviar congestión
- Útil para estimular
- Útil si no hay extractor
- Colocar dedos en forma de “C”
- Presionar hacia atrás y después comprimir
- No deslizar sobre la piel
...
- Tiempos aproximados:
  - pueden variar según higiene, temperatura real y protocolo del centro
...
- Aplicar hojas frías sobre el pecho durante periodos cortos
- No abusar del uso continuado
...
- Técnica útil cuando hay edema o inflamación
- Ayuda a desplazar líquidos alrededor del pezón
- Facilita el agarre del bebé
- Puede hacerse con:
  - dedos
  - nudillos
  - pulgares
- Presionar suavemente alrededor del pezón durante unos segundos

## 🔥 Mastitis ✨✨✨

- Inflamación del pecho
- Puede ser infecciosa o no
- Intentar atajarla antes de 24h
- Mantener vaciado del pecho
- Continuar lactancia normalmente si se tolera
- Frío local después de tomas
- Evitar masajes agresivos
- Reposo e hidratación
- Consultar si empeora o aparecen síntomas sistémicos
- Consultar rápido si hay:
  - fiebre
  - dolor intenso
  - enrojecimiento
  - malestar general
...
- Pequeño punto blanco en el pezón
- Relacionado con obstrucción de salida de leche

### Recomendaciones

1. Aplicar calor antes de la toma
2. La succión del bebé puede ayudar a resolverlo
3. Frotar suavemente con gasa y agua templada/salina
4. Si persiste:
   - consultar matrona
...
- “Mucha teta” — Alba Padró
- “El mejor regalo” — Carlos González
...
- https://aelama.org
- Nota:
  - e-lactancia sirve para consultar compatibilidad de medicamentos con lactancia

### Vídeos

- Posiciones para amamantar:
  - https://youtu.be/YXwx-B1i-o
- Dolor en las mamas:
  - https://youtu.be/1pS9o9pYY8E
...
- Viernes 10:30-12:00
- excepto primer viernes de mes
- CS Miguel de Cervantes

### Teléfono lactancia HUPA

- 651 834 333

### Grupos de apoyo

- Grupo Lactard (Alcalá de Henares)
  - Centro Galatea
  - lunes 12:00-13:30

- Grupo Lactard (Torrejón)
  - martes 18:00-19:30
...
<!-- lesson-id: cuidados-bebe -->
# Cuidados básicos del recién nacido

Esta lección reúne cuidados diarios y señales para consultar.
...
Completar con recomendaciones actualizadas de pediatría y las indicaciones dadas al alta.

<!-- lesson-id: higiene-recien-nacido -->
# Higiene, cólicos y masaje infantil

Cuidados básicos para los primeros días y semanas del recién nacido. Son pautas prácticas para revisar en casa y adaptar siempre a las indicaciones de pediatría o matrona.
...
- Se recomienda empezar a partir de las 24 horas de vida.
- Como referencia, pueden ser suficientes 2-3 baños por semana.

#### Temperatura

- Temperatura ambiente recomendada: 20-22 °C.
- Temperatura del agua: 36.5-37 °C.
- Comprobar la temperatura con el codo.

#### Cómo preparar el baño

- Usar entre 5 y 15 cm de agua.
- Duración aproximada: 10 minutos.
- Utilizar jabones específicos para bebés.

#### Consejos

- El baño puede convertirse en un momento relajante.
- Ayuda a crear rutinas y hábito.
- Secar bien todos los pliegues:
  - axilas
  - ingles
  - cuello
...
- Se puede usar crema o aceite corporal.
- El aceite se recomienda aplicarlo con la piel húmeda.

### Uñas

- No cortar las uñas hasta aproximadamente las 3 semanas.
- Utilizar lima de cristal.
...
- Usar productos específicos para bebés.
- No son imprescindibles durante los primeros días.
- Se pueden usar aceites para hidratar.
...
- Evitar abrigarlo demasiado.
- Como referencia: una capa más que un adulto en reposo.
...
- Lavar su ropa aparte.
- Usar jabón para prendas delicadas.

#### Calor

- En épocas de calor usar ropa ligera de algodón.
- Se puede usar una brisa suave con ventilador o abanico.
- Evitar el uso de talco.
...
- El intestino del recién nacido todavía es inmaduro.
- Esto puede provocar espasmos y molestias.

#### Qué puede ayudar

- Colocarlo boca abajo sobre el antebrazo.
- Balancearlo suavemente.
- Realizar masajes abdominales suaves.
- Hacer movimientos siguiendo el sentido de las agujas del reloj.
- Dar un baño tibio.
- Colocarlo en posición fetal.
- Darle el pecho, ya que puede tener un efecto calmante.
...
- Hacer movimientos suaves y sin presión excesiva.
- Parar si el bebé se incomoda, llora más o parece molesto.

#### Técnicas

- Realizar círculos en el abdomen siguiendo las agujas del reloj.
- Una mano puede hacer un círculo completo.
- La otra mano puede hacer un medio círculo, de las 10 a las 5.
- Repetir 6 veces.

#### Rueda hidráulica

- Deslizar las manos por debajo del ombligo.
- Repetir 6 veces.

#### Flexión de piernas

- Juntar las rodillas.
- Presionar suavemente hacia el abdomen.
...
- Colocar al bebé en posición vertical:
  - sobre el hombro
  - sentado
  - o en postura del avión
- Frotar suavemente la espalda para ayudar a expulsar los gases.

## Masaje infantil

### Beneficios

- Fortalece el apego y vínculo afectivo.
- Ayuda a relajarse y liberar tensiones.
- Puede aliviar molestias y dolor.
- Estimula la circulación sanguínea.
- Favorece el drenaje linfático.
- Ayuda al sistema respiratorio.
- Puede favorecer la autoestima y seguridad emocional.

## Para añadir imágenes más adelante

- Mantenerlas como apoyo visual, no como contenido imprescindible.
- Usar imágenes ligeras y optimizadas.
- Añadir siempre texto alternativo claro.
- Revisar que no incluyan datos personales ni permitan identificar al bebé o a la familia.

<!-- lesson-id: panales-cacas-culete -->
# Pañales, cacas y cuidado del culete

Guía práctica para observar pipí, cacas, cambios normales y cuidado de la piel. La idea es mirar el conjunto: pañales, tomas, peso y estado general del bebé.

## Por qué importan los pañales

Los pañales dan mucha información sobre cómo está el bebé.

- El pipí es una señal importante de hidratación.
- Si hace pis con frecuencia, suele indicar que está hidratado y que está comiendo suficiente.
- Las deposiciones ayudan a valorar si la alimentación va bien.
- La frecuencia de las cacas puede variar mucho entre bebés.

## Frecuencia de las deposiciones

En los primeros días es habitual que el recién nacido haga caca todos los días.

Al nacer, cada vez que come se activa el reflejo gastrocólico. Por eso algunos bebés hacen caca con cada toma.

Hacia las 3 o 4 semanas, el intestino puede volverse más eficiente absorbiendo nutrientes y algunos bebés hacen caca con menos frecuencia.

Puede ser normal si:

- el bebé hace pis abundantemente
- come bien
- recupera o gana peso adecuadamente
- está tranquilo o con buen estado general

No hay que valorar solo la frecuencia de las cacas, sino el conjunto.

## Cambios normales de color

La caca del bebé cambia durante los primeros días:

- al principio es meconio, de color negro verdoso
- hacia el tercer o cuarto día suele aclararse
- después puede pasar a un tono amarillo mostaza

En lactancia materna, el color suele ser amarillo dorado y las heces pueden ser blandas, con algo de moco o grumitos.

Con leche artificial, pueden variar más hacia tonos amarillos claros o verdosos.

Estos cambios suelen ser normales.

## Señales a vigilar

Consultar con pediatría o matrona si:

- el bebé no hace pis suficiente
- no recupera peso o pierde demasiado peso
- hay varios días sin caca en los primeros días y además parece que no come bien
- las heces tienen sangre
- el bebé está decaído, con mal color o rechaza las tomas
- hay dudas claras sobre la alimentación

Evitar normalizar una situación solo porque cada bebé es distinto. Hay que mirar el conjunto: pis, peso, alimentación y estado general.

## Cambio de pañal

Es importante cambiar el pañal cuando detectamos que tiene caca, porque el contacto prolongado con heces puede irritar la piel.

Con el pipí, el cambio dependerá de cómo notemos el pañal de cargado. Los pañales actuales suelen absorber bastante bien.

## Limpieza

En casa, se puede limpiar con agua.

También se puede usar linimento como alternativa a las toallitas.

Recomendación práctica:

- priorizar productos sencillos y respetuosos con la piel
- evitar abusar de toallitas si irritan
- elegir toallitas con pocos ingredientes y, si es posible, con alto porcentaje de agua

## Pomadas

No es necesario poner pomada de forma preventiva en cada cambio de pañal.

La piel necesita respirar.

Se puede usar pomada cuando:

- el culete está rojo
- hay irritación
- aparece dermatitis del pañal

Priorizar pomadas con mayor cantidad de zinc por su efecto antiinflamatorio y barrera.

También existen opciones reparadoras tipo pasta al agua o cremas reparadoras, útiles cuando la piel está más irritada.

## Dermatitis del pañal

La dermatitis suele estar relacionada con:

- humedad
- contacto con orina y heces
- irritación de la piel
- exceso de productos o limpieza agresiva
...
- usar pomada si hay irritación

Si no mejora con cambios frecuentes de pañal, aireación y pomada habitual, consultar con pediatría.

A veces puede haber sobreinfección por cándida y puede requerir tratamiento específico indicado por un profesional.

## Resumen rápido

- El pipí ayuda a saber si el bebé está hidratado.
- La frecuencia de las cacas puede variar.
- Los primeros días la caca cambia de negro verdoso a amarillo mostaza.
- No mirar solo las cacas: valorar también peso, tomas y estado general.
- Cambiar rápido si hay caca.
- No hace falta pomada en cada cambio.
- Usar pomada si hay irritación.
- Si la dermatitis no mejora, consultar.

## Para añadir imágenes más adelante

- Foto o esquema de cambios normales de color de caca, sin datos personales.
- Imagen simple de material de cambio de pañal.
- Recordatorio visual de limpieza suave y secado sin frotar.
